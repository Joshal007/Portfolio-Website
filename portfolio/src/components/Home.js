            ...
            <div className="home_container container grid">
                <div className="home_content grid">
                    <div className="home_social">
                        <a href="https://www.linkedin.com/in/joshal-joshi/" className="home_social-icon" target="_blank">
                            <FaLinkedin />
                        </a>
                        <a href="https://www.leetcode.com/Joshi_Joshal007" className="home_social-icon" target="_blank">
                            <SiLeetcode />
                        </a>
                        <a href="https://www.instagram.com/joshal_135/" className="home_social-icon" target="_blank">
                            <FaInstagram />
                        </a>
                        <a href="https://github.com/Joshal007" className="home_social-icon" target="_blank">
                            <FaGithub />
                        </a>
                    ...
                    <div className="home_data">
                        ...
                        <h1 className="heading-name">
                            <strong className="main-name">Joshal Joshi</strong>
                        </h1>
                        {/* <h1 className="home_title">Joshal Joshi
                            <svg
                                width="36"
                                height="36"
                                viewBox="0 0 48 48"
                        ...
                        <h3 className="home_subtitle">
                            <ul className="dynamic-txt">
                                <li><span>Computer Science Engineer</span></li>
                                <li><span>Full Stack Developer</span></li>
                                <li><span>Competitive Programmer</span></li>
                            </ul>
                        </h3>
                        <p className="home_description">Aiming to join an organization as a Full Stack Developer that encourages creativity and innovation.</p>
